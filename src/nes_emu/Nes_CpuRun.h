...
#define NES_CPU_TRACEWRITE( cpu, addr, data, time ){\
	RUNMEMTRACE(addr, data) \
    NES_CPU_WRITE(cpu, addr, data, time) \
}
...
#define WRITE( addr, data ) {NES_CPU_TRACEWRITE( this, (addr), (data), (clock_count) );}
